...
$email = 'tarangdube786@gmail.com';
$apiKey = 'F6F32F9D-DB28-4B82-899A-5CB46DD2C463';
...
try{
	...
	$additionalHeaders = array($clConst['SANDBOX_MODE_HEADER'], // Sandbox mode - Scan without consuming any credits and get back dummy results
                                $clConst['HTTP_CALLBACK'].': http://requestbin.fullcontact.com/v3vdd8v3' # For a fast testing of callbacks option we recommend to use http://requestb.in
