...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_00000000334d395e0000000030d2c2be(
...
class phpbbtemplatetwiglexer_00000000334d395e0000000030d2c2be extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5aa53b42b718e706208609 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5aa53b42b7202444338869 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5aa53b42b708e191961845 = array(
    ...
    {
        $this->initializer5aa53b42b7202444338869 && ($this->initializer5aa53b42b7202444338869->__invoke($valueHolder5aa53b42b718e706208609, $this, 'set_environment', array('env' => $env), $this->initializer5aa53b42b7202444338869) || 1) && $this->valueHolder5aa53b42b718e706208609 = $valueHolder5aa53b42b718e706208609;

        return $this->valueHolder5aa53b42b718e706208609->set_environment($env);
    }
    ...
    {
        $this->initializer5aa53b42b7202444338869 && ($this->initializer5aa53b42b7202444338869->__invoke($valueHolder5aa53b42b718e706208609, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5aa53b42b7202444338869) || 1) && $this->valueHolder5aa53b42b718e706208609 = $valueHolder5aa53b42b718e706208609;

        return $this->valueHolder5aa53b42b718e706208609->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5aa53b42b7202444338869 && ($this->initializer5aa53b42b7202444338869->__invoke($valueHolder5aa53b42b718e706208609, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5aa53b42b7202444338869) || 1) && $this->valueHolder5aa53b42b718e706208609 = $valueHolder5aa53b42b718e706208609;

        return $this->valueHolder5aa53b42b718e706208609->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5aa53b42b7202444338869 = $initializer;
    }
    ...
    {
        $this->initializer5aa53b42b7202444338869 && ($this->initializer5aa53b42b7202444338869->__invoke($valueHolder5aa53b42b718e706208609, $this, '__get', array('name' => $name), $this->initializer5aa53b42b7202444338869) || 1) && $this->valueHolder5aa53b42b718e706208609 = $valueHolder5aa53b42b718e706208609;

        if (isset(self::$publicProperties5aa53b42b708e191961845[$name])) {
            return $this->valueHolder5aa53b42b718e706208609->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5aa53b42b718e706208609;
    ...
    {
        $this->initializer5aa53b42b7202444338869 && ($this->initializer5aa53b42b7202444338869->__invoke($valueHolder5aa53b42b718e706208609, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5aa53b42b7202444338869) || 1) && $this->valueHolder5aa53b42b718e706208609 = $valueHolder5aa53b42b718e706208609;
    ...
    {
        $this->initializer5aa53b42b7202444338869 && ($this->initializer5aa53b42b7202444338869->__invoke($valueHolder5aa53b42b718e706208609, $this, '__isset', array('name' => $name), $this->initializer5aa53b42b7202444338869) || 1) && $this->valueHolder5aa53b42b718e706208609 = $valueHolder5aa53b42b718e706208609;
    ...
    {
        $this->initializer5aa53b42b7202444338869 && ($this->initializer5aa53b42b7202444338869->__invoke($valueHolder5aa53b42b718e706208609, $this, '__unset', array('name' => $name), $this->initializer5aa53b42b7202444338869) || 1) && $this->valueHolder5aa53b42b718e706208609 = $valueHolder5aa53b42b718e706208609;
    ...
    {
        $this->initializer5aa53b42b7202444338869 && ($this->initializer5aa53b42b7202444338869->__invoke($valueHolder5aa53b42b718e706208609, $this, '__clone', array(), $this->initializer5aa53b42b7202444338869) || 1) && $this->valueHolder5aa53b42b718e706208609 = $valueHolder5aa53b42b718e706208609;

        $this->valueHolder5aa53b42b718e706208609 = clone $this->valueHolder5aa53b42b718e706208609;
    }

    public function __sleep()
    {
        $this->initializer5aa53b42b7202444338869 && ($this->initializer5aa53b42b7202444338869->__invoke($valueHolder5aa53b42b718e706208609, $this, '__sleep', array(), $this->initializer5aa53b42b7202444338869) || 1) && $this->valueHolder5aa53b42b718e706208609 = $valueHolder5aa53b42b718e706208609;

        return array('valueHolder5aa53b42b718e706208609');
    }
    ...
    {
        return $this->initializer5aa53b42b7202444338869;
    }
    ...
    {
        return $this->initializer5aa53b42b7202444338869 && ($this->initializer5aa53b42b7202444338869->__invoke($valueHolder5aa53b42b718e706208609, $this, 'initializeProxy', array(), $this->initializer5aa53b42b7202444338869) || 1) && $this->valueHolder5aa53b42b718e706208609 = $valueHolder5aa53b42b718e706208609;
    }
    ...
    {
        return null !== $this->valueHolder5aa53b42b718e706208609;
    }
    ...
    {
        return $this->valueHolder5aa53b42b718e706208609;
    }
