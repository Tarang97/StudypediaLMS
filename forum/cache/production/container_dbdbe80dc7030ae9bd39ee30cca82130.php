...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_0000000000cc15ae000000004a33c931(
...
class phpbbtemplatetwiglexer_0000000000cc15ae000000004a33c931 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5aa538ab80710289562949 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5aa538ab80749683367911 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5aa538ab80691943126049 = array(
    ...
    {
        $this->initializer5aa538ab80749683367911 && ($this->initializer5aa538ab80749683367911->__invoke($valueHolder5aa538ab80710289562949, $this, 'set_environment', array('env' => $env), $this->initializer5aa538ab80749683367911) || 1) && $this->valueHolder5aa538ab80710289562949 = $valueHolder5aa538ab80710289562949;

        return $this->valueHolder5aa538ab80710289562949->set_environment($env);
    }
    ...
    {
        $this->initializer5aa538ab80749683367911 && ($this->initializer5aa538ab80749683367911->__invoke($valueHolder5aa538ab80710289562949, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5aa538ab80749683367911) || 1) && $this->valueHolder5aa538ab80710289562949 = $valueHolder5aa538ab80710289562949;

        return $this->valueHolder5aa538ab80710289562949->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5aa538ab80749683367911 && ($this->initializer5aa538ab80749683367911->__invoke($valueHolder5aa538ab80710289562949, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5aa538ab80749683367911) || 1) && $this->valueHolder5aa538ab80710289562949 = $valueHolder5aa538ab80710289562949;

        return $this->valueHolder5aa538ab80710289562949->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5aa538ab80749683367911 = $initializer;
    }
    ...
    {
        $this->initializer5aa538ab80749683367911 && ($this->initializer5aa538ab80749683367911->__invoke($valueHolder5aa538ab80710289562949, $this, '__get', array('name' => $name), $this->initializer5aa538ab80749683367911) || 1) && $this->valueHolder5aa538ab80710289562949 = $valueHolder5aa538ab80710289562949;

        if (isset(self::$publicProperties5aa538ab80691943126049[$name])) {
            return $this->valueHolder5aa538ab80710289562949->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5aa538ab80710289562949;
    ...
    {
        $this->initializer5aa538ab80749683367911 && ($this->initializer5aa538ab80749683367911->__invoke($valueHolder5aa538ab80710289562949, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5aa538ab80749683367911) || 1) && $this->valueHolder5aa538ab80710289562949 = $valueHolder5aa538ab80710289562949;
    ...
    {
        $this->initializer5aa538ab80749683367911 && ($this->initializer5aa538ab80749683367911->__invoke($valueHolder5aa538ab80710289562949, $this, '__isset', array('name' => $name), $this->initializer5aa538ab80749683367911) || 1) && $this->valueHolder5aa538ab80710289562949 = $valueHolder5aa538ab80710289562949;
    ...
    {
        $this->initializer5aa538ab80749683367911 && ($this->initializer5aa538ab80749683367911->__invoke($valueHolder5aa538ab80710289562949, $this, '__unset', array('name' => $name), $this->initializer5aa538ab80749683367911) || 1) && $this->valueHolder5aa538ab80710289562949 = $valueHolder5aa538ab80710289562949;
    ...
    {
        $this->initializer5aa538ab80749683367911 && ($this->initializer5aa538ab80749683367911->__invoke($valueHolder5aa538ab80710289562949, $this, '__clone', array(), $this->initializer5aa538ab80749683367911) || 1) && $this->valueHolder5aa538ab80710289562949 = $valueHolder5aa538ab80710289562949;

        $this->valueHolder5aa538ab80710289562949 = clone $this->valueHolder5aa538ab80710289562949;
    }

    public function __sleep()
    {
        $this->initializer5aa538ab80749683367911 && ($this->initializer5aa538ab80749683367911->__invoke($valueHolder5aa538ab80710289562949, $this, '__sleep', array(), $this->initializer5aa538ab80749683367911) || 1) && $this->valueHolder5aa538ab80710289562949 = $valueHolder5aa538ab80710289562949;

        return array('valueHolder5aa538ab80710289562949');
    }
    ...
    {
        return $this->initializer5aa538ab80749683367911;
    }
    ...
    {
        return $this->initializer5aa538ab80749683367911 && ($this->initializer5aa538ab80749683367911->__invoke($valueHolder5aa538ab80710289562949, $this, 'initializeProxy', array(), $this->initializer5aa538ab80749683367911) || 1) && $this->valueHolder5aa538ab80710289562949 = $valueHolder5aa538ab80710289562949;
    }
    ...
    {
        return null !== $this->valueHolder5aa538ab80710289562949;
    }
    ...
    {
        return $this->valueHolder5aa538ab80710289562949;
    }
